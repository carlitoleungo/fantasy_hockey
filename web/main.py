...
from web.routes.projection import public_router as projection_public_router
from web.routes.projection import router as projection_router
...
app.include_router(projection_public_router)
